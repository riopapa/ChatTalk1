...
import static biz.riopapa.chattalk.Vars.HIDE_STOP;
import static biz.riopapa.chattalk.Vars.RELOAD_APP;
import static biz.riopapa.chattalk.Vars.SHOW_MESSAGE;
import static biz.riopapa.chattalk.Vars.STOP_SAY1;
...
//                .setStyle(new NotificationCompat.BigTextStyle())
    ...
    private void updateRemoteViews() {
        ...
        mBuilder.setSmallIcon(R.drawable.chat_talk_logo);
